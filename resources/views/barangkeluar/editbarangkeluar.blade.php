  ...
  <div class="card-header">
    ...
    @if($data->buatba==0)
		...
		<div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
			<a class="dropdown-item text-dark" href="{{route('bast', \Hashids::encode($data->BA_ID))}}">BA Serah Terima</a>
			<!-- <a class="dropdown-item text-dark" href="{{route('bapp', $data->BA_ID)}}">BA Pinjam Pakai</a> -->
		...
		<div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
			...
			<a href="{{route('bast', \Hashids::encode ($data->BA_ID))}}" class="dropdown-item text-dark">Lihat BA</a>
			@else --}}
			<a href="{{route('bast', \Hashids::encode($data->BA_ID))}}" class="dropdown-item text-dark">Lihat BA</a>
			{{-- @endif --}}
		</div>
	...
	@endif
		<div class="card-tools">
			@if($data->aktif==1)
			<a class="btn btn-warning btn-sm" href="{{route('barangkeluar')}}">Kembali</a>
			@elseif($data->aktif==2) 
			<a class="btn btn-warning btn-sm" href="{{route('keranjangbarangkeluar')}}">Kembali</a>
			@endif
		</div>
  ...
  <div class="card-body">
	<form action="{{route('updatebarangkeluar', $data->id)}}" method="post">
		...
		<div class="form-group">
			...
			<input type="text" class="form-control" name="serial_number" value="{{ implode(', ', $serialNumbers) }}" readonly>
		</div>
