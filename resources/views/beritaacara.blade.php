                ...
                <div class="card">
                    <div class="card-header">FORM BERITA ACARA - {{ $data->nama_barang }}
                        ...
                        <div class="text-right">
                            <a href="{{ route('outputba', \Hashids::encode($data->id)) }}" class="btn btn-primary btn-sm"
                                target="_blank">Lihat Berita Acara</a>
                            <a href="{{ route('downloadba', \Hashids::encode($data->id)) }}" class="btn btn-success btn-sm"
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('updateba', $data->id) }}" method="post" enctype="multipart/form-data">
                            ...
                            <input type="hidden" name="buatba" value="1">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"
                                            value="{{ url('/beritaacara/user/' . \Hashids::encode($data->id)) }}"
                                            id="myInput">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>&nbsp;</label>
                                        <a class="btn btn-block btn-success" onclick="myFunction()">Copy to
                                            Clipboard</i></a>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="nomor"
                                            value="{{ $data->nomor }}"required autocomplete="nomor" autofokus>
                                    </div>
                                </div>
                            </div>
                        ...
                        <input type="text" class="form-control" name="serialnumber" value="{{$data->serialnumber}}">
                            ...
                            <div class="form-group">
                                <label>Jumlah</label>
                                <input type="text" class="form-control" name="jumlah" value="{{ $data->JK }}"
                                    readonly>
                            </div>
                            <div class="form-group">
                                <label>Serial_number</label>
                                <input type="text" class="form-control" name="serial_number"
                                    value="{{ implode(', ', $serialNumbers) }}" readonly>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                @else
                                    <img id="foto" src="{{ asset('fotobarang/' . $data->foto) }}" width="350" />
                                    <br>
                                @endif
                                <input id="fotos" type="file" class="form-control" name="foto"
                                    style="margin-top: 20px;" value="{{ $data->foto }}">
                            </div>
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="ttd_p1">Digital Signature Pihak Kesatu
                                                    </h5>
                                ...
                                <div class="col-md-6" style="text-align: center;">
                                    ...
                                    <div class="modal fade" id="ttd_p2" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="ttd_p2">Digital Signature Pihak Kedua
                                                    </h5>
                                                    <button type="button" class="close" data-dismiss="modal"
                                                        aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                                ...
                                <div class="col-md-12" style="text-align: center;">
                                    ...
                                    <div class="modal fade" id="ttd_p3" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="ttd_p3">Digital Signature Satpel
                                                        Prasasti</h5>
                                                    <button type="button" class="close" data-dismiss="modal"
                                                        aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
...
@push('scripts')
    ...
    <!-- {{-- <script src="http://maxcdn.bootstrapcdn.com/bootstrap/3.2.0/js/bootstrap.min.js"></script> --}}
    {{-- <script src="{{asset('plugin/spad/spad/docs/js/signature_pad.umd.js')}}"></script> --}} -->
